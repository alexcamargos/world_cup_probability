...
DDL_STATEMENTS: tuple[str, ...] = (
    ...
    CREATE TABLE IF NOT EXISTS d_squad_attributes (
        ...
        avg_pace DOUBLE,
        avg_stamina DOUBLE,
        avg_goalkeeper_overall DOUBLE,
        avg_defense_overall DOUBLE,
        avg_midfield_overall DOUBLE,
        avg_attack_overall DOUBLE,
...
def _migrate_schema(con: duckdb.DuckDBPyConnection) -> None:
    migration_statements = (
        ...
        "ALTER TABLE f_match_stats ADD COLUMN IF NOT EXISTS shots DOUBLE",
        "ALTER TABLE f_match_stats ADD COLUMN IF NOT EXISTS shots_on_target DOUBLE",
        "ALTER TABLE f_match_stats ADD COLUMN IF NOT EXISTS corners DOUBLE",
        "ALTER TABLE f_match_stats ADD COLUMN IF NOT EXISTS yellow_cards DOUBLE",
        "ALTER TABLE f_match_stats ADD COLUMN IF NOT EXISTS red_cards DOUBLE",
        "ALTER TABLE d_squad_attributes ADD COLUMN IF NOT EXISTS avg_goalkeeper_overall DOUBLE",
        "ALTER TABLE d_squad_attributes ADD COLUMN IF NOT EXISTS avg_defense_overall DOUBLE",
        "ALTER TABLE d_squad_attributes ADD COLUMN IF NOT EXISTS avg_midfield_overall DOUBLE",
        "ALTER TABLE d_squad_attributes ADD COLUMN IF NOT EXISTS avg_attack_overall DOUBLE",
    )
